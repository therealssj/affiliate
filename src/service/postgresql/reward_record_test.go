...
func TestRewardRecord(t *testing.T) {
	...
	dr := db.DepositRecord{MappingId: mappingId, Seq: 1, UpdatedAt: time.Now().Unix(), TransactionId: "testTransactionId", DepositAmount: 100, BuyAmount: 10000, Rate: "100", Height: 101, CurrencyType: currencyType, DepositAddr: "testDepositAddr", BuyAddr: "testBuyAddr"}
